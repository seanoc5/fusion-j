 ...
 */
class QueryProfiles extends BaseObject {
    Logger log = Logger.getLogger(this.class.name);

    QueryProfiles(String appName, List<Map<String, Object>> srcJsonList) {
        super(appName, srcJsonList)
    }

    QueryProfiles(String appName, Map<String, Object> srcJsonMap) {
